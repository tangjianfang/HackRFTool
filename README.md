...
| 当前状态 | **M2 完成（2026-09-05）**：频谱+瀑布 v0.1 与信道监测/统计/CSV 导出 v0.2 已交付，见 [docs/m2-交付记录.md](docs/m2-交付记录.md)（M1 见 [docs/m1-交付记录.md](docs/m1-交付记录.md)，M0 见 [docs/m0-环境验证记录.md](docs/m0-环境验证记录.md)） |
